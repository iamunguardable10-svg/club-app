...
| 17 | Team-Nachrichten (erledigt, Run 23; gelesen = gesehen, entschieden 2026-09-25) | Nur Ankündigungen, keine Antworten. Trainer (neues Recht `postMessages`, Head Coach immer) schreibt an Team oder Gruppen: Text, optional „wichtig“ (oben angeheftet). Push an alle Empfänger (abschaltbar, außer „wichtig“). Spieler tippen **„Gelesen“**; Trainer sieht „gelesen 14/18“ und wer fehlt, kann einmal erinnern. Nachrichtenliste im Team; eine Karte auf „Heute“ für ungelesene | mittel |
