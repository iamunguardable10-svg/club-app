...
function ProductPreviewCard() {
  return (
    <div className="relative mx-auto mt-8 w-full max-w-4xl overflow-hidden rounded-[2rem] border border-white/10 bg-white/[0.04] p-4 shadow-[0_32px_120px_rgba(14,165,233,0.12)] backdrop-blur-xl 2xl:hidden">
      ...
      <div className="relative rounded-[1.5rem] border border-sky-400/20 bg-slate-950/95 p-4 shadow-2xl sm:p-5">
        <div className="flex items-start justify-between gap-3">
          <div>
            <p className="text-[10px] font-black uppercase tracking-[0.22em] text-sky-300 sm:text-xs">Today cockpit</p>
            <h2 className="mt-2 text-xl font-black sm:text-2xl">U18 Boys Training</h2>
          </div>
          <span className="rounded-full bg-emerald-400 px-3 py-1 text-[11px] font-black text-slate-950 sm:px-3 sm:py-1.5 sm:text-xs">Live</span>
        </div>

        <div className="mt-4 grid grid-cols-3 gap-2 sm:gap-3">
          <div className="rounded-2xl bg-emerald-400/10 p-3 ring-1 ring-emerald-300/10 sm:p-4">
            <p className="text-2xl font-black text-emerald-200 sm:text-3xl">14</p>
            <p className="text-[10px] font-bold text-emerald-100/70 sm:text-xs">expected</p>
          </div>
          <div className="rounded-2xl bg-amber-300/10 p-3 ring-1 ring-amber-300/10 sm:p-4">
            <p className="text-2xl font-black text-amber-200 sm:text-3xl">3</p>
            <p className="text-[10px] font-bold text-amber-100/70 sm:text-xs">maybe</p>
          </div>
          <div className="rounded-2xl bg-red-400/10 p-3 ring-1 ring-red-300/10 sm:p-4">
            <p className="text-2xl font-black text-red-200 sm:text-3xl">2</p>
            <p className="text-[10px] font-bold text-red-100/70 sm:text-xs">missing</p>
          </div>
        </div>

        <div className="mt-4 grid gap-3 md:grid-cols-[0.9fr_1.1fr]">
          <div className="rounded-2xl border border-slate-800 bg-slate-900/80 p-4">
            <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-[0.16em] text-slate-500 sm:text-xs">
              <span>Readiness</span>
            ...
            <div className="mt-4 grid grid-cols-12 items-end gap-1">
              {readinessBars.map((height, index) => (
                <span
                  ...
                  style={{ height: `${Math.max(18, Math.round(height * 0.7))}px`, animationDelay: `${index * 55}ms` }}
                />
              ))}
            </div>
          </div>
      ...
      <div className="relative mt-3 grid gap-3 sm:grid-cols-2">
        <div className="rounded-2xl border border-violet-400/20 bg-slate-950/90 p-3 sm:p-4">
          <p className="text-[10px] font-black uppercase tracking-[0.16em] text-violet-300 sm:text-xs">Club structure</p>
          <p className="mt-2 text-xs font-bold text-slate-300 sm:text-sm">Basketball → U18 Boys</p>
          <p className="mt-1 text-xs font-bold text-slate-500 sm:text-sm">Facilities → Main Hall</p>
        </div>
        <div className="rounded-2xl border border-emerald-400/20 bg-slate-950/90 p-3 sm:p-4">
          <p className="text-[10px] font-black uppercase tracking-[0.16em] text-emerald-300 sm:text-xs">Upcoming sessions</p>
          <p className="mt-2 text-xs font-bold text-slate-300 sm:text-sm">Training · 09:00</p>
          <p className="mt-1 text-xs font-bold text-slate-500 sm:text-sm">Load opens after session</p>
        </div>
      </div>
    </div>
  );
...
function DesktopProductStage() {
  return (
    <div className="landing-stage relative hidden min-h-[46rem] overflow-visible 2xl:block">
      ...
      <div className="landing-board absolute left-1/2 top-10 w-[min(100%,54rem)] -translate-x-1/2">
      ...
      <div className="absolute bottom-20 left-4 w-[52%] max-w-[28rem]">
      ...
      <div className="absolute bottom-24 right-4 w-[40%] min-w-[15rem] max-w-[24rem]">
      ...
      <div className="absolute bottom-4 right-4 rounded-2xl border border-emerald-300/30 bg-emerald-300 px-4 py-3 text-sm font-black text-slate-950 shadow-[0_20px_80px_rgba(52,211,153,0.28)] transition duration-700 hover:-translate-y-2">
        3D operations board
      </div>
    </div>
  );
...
export default function HomePage() {
  return (
    <main className="min-h-screen overflow-hidden bg-[#050712] text-white">
      ...
      <section className="mx-auto grid max-w-[92rem] gap-8 px-4 pb-10 pt-4 sm:px-8 lg:pb-16 lg:pt-8 2xl:grid-cols-[0.82fr_1.18fr] 2xl:items-center 2xl:gap-12">
        <div className="relative z-10">
          ...
          <h1 className="mt-5 max-w-[10ch] text-[3.35rem] font-black leading-[0.9] tracking-tight text-white min-[380px]:text-[3.75rem] sm:mt-6 sm:text-[5.2rem] lg:text-[5.8rem] 2xl:max-w-[9.6ch] 2xl:text-[7rem]">
